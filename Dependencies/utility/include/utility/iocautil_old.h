...
namespace util::io {
    ...
    public:
        ...
        bool contains_l(const std::string& element) const
        {
        ...
        int location_l(const char* data) const
        {
        ...
        std::string lower(const std::string& data) const
        {
            std::string result;
        ...
        inline const std::string& operator[](const int& index) const { return m_InputStrings[index]; }
